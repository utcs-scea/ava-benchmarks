...
int main(int argc, char const *argv[]) {
  ...
  // load graph
  // ================================================================================
  TF_Buffer* graph_def = read_file("./files/exported/graph.pb");
  ...
  fprintf(stdout, "Start to run first session\n");
  TF_SessionRun(sess,
                /* RunOptions */         NULL,
  ...
  char* checkpoint_path_str = "./files/exported/my_model";
  ...
  fprintf(stdout, "Start to run second session\n");
  TF_SessionRun(sess,
                /* RunOptions */         NULL,
  ...
  */
  ...
  // run network
  // ================================================================================
  fprintf(stdout, "Start to run third session\n");
  TF_SessionRun(sess,
                /* RunOptions */         NULL,
