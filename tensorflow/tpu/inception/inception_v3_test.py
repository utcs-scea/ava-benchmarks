...
#  x = pickle.dumps(inception_model_fn)
#  print(pickle.loads(x))
#  x = pickle.temp.dump_source(inception_model_fn)
#  y = pickle.temp.load_source(x)
#  print(y)
  ...
  print(inception_classifier, inception_classifier.object_id())
