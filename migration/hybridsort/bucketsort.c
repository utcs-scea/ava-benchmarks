...
void histogram1024GPU(unsigned int *h_Result, float *d_Data, float minimum, float maximum,int listsize) {
    ...
    local = 96;
#endif
    err = clEnqueueNDRangeKernel(histoCommands, histoKernel, 1, NULL, &global, &local, 0, NULL, NULL);
    if (err)
    {
...
//	///////////////////////////////////////////////////////////////////////////
    ...
    err = clEnqueueNDRangeKernel(bucketCommands, bucketcountKernel, 3, NULL, global, local, 0, NULL, NULL);
    if (err)
    {
...
//	///////////////////////////////////////////////////////////////////////////
    ...
    err = clEnqueueNDRangeKernel(bucketCommands, bucketprefixKernel, 3, NULL, globalpre, localpre, 0, NULL, NULL);
    if (err)
    {
...
//	///////////////////////////////////////////////////////////////////////////
    ...
    err = clEnqueueNDRangeKernel(bucketCommands, bucketsortKernel, 3, NULL, globalfinal, localfinal, 0, NULL, NULL);
    if (err)
    {
